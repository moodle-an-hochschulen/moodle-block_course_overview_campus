...
$string['teacherrolessettingheading'] = 'Teacher filter: Teacher roles';
$string['teacherroles'] = 'Teacher roles';
$string['teacherroles_desc'] = 'Users who have one of these roles in a course are displayed besides the course\'s name as teacher and get listed in the teacher filter.<br /><em>This setting is only processed when show teacher name is activated or when the teacher filter is activated or when the priorization of courses in which I teach is activated</em>';
$string['term'] = 'Term';
$string['term1'] = 'Term 1';
